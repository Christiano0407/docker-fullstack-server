...
def mock_csv_missing():
    ...
    with patch("app.services.data_product_workflow.DATA_PATH") as mock_path:
...
class TestParseRow:
    ...
    def test_parse_row_maps_white_space(self):
        ...
        raw = {
            ...
            "Genre": " Comedy ",
            "Rating": " G ",
            "TotalGross": "217350219",
            "AdjustedGross": "441969178",
        }

        result = _parse_row(raw)

        assert result["movie_title"] == "Aladdin"
    ...
    def test_parse_row_maps_gros_to_int(self):
        ...
        raw = {
            ...
            "Genre": "Musical",
            "Rating": "G",
            "TotalGross": "218951625",
            "AdjustedGross": "363017667",
        }
...
class testLoadPaginatedData:
    ...
    def test_load_data_limit(self, mock_load_all):
        """Limit the movies = 10"""
        from app.services.data_product_workflow import get_data_paginated
    ...
    def test_load_data_total(self, mock_load_all):
    ...
    def test_load_data_respect_limit(self, mock_load_all):
    ...
    def test_load_data_respect_offset(self, mock_load_all):
        """
    ...
    def test_load_data_offset_beyond_total_return_empty(self, mock_load_all):
        from app.services.data_product_workflow import get_data_paginated
    ...
    def test_load_data_row_correct(self, mock_load_all):
...
class TestGetMoviesTitle:
    ...
    def test_movies_title_all_keys(self, mock_load_all):
        ...
        assert result is not None, "Movie should be found in mock data"
        expected_keys = {
            "movie_title",
            "release_date",
            "genre",
...
class TestSearchFilterMovies:
    ...
    def test_filtered(self, mock_load_all):
        ...
        assert (
            len(rows) == 2
            and all(r["genre"] == "Adventure" for r in rows)
            and all(ro["rating"] == "G" for ro in rows)
        )
        assert total == 3
